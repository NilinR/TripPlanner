...
def flight():
    ...
    global cal
    cal = Calendar(frame, selectmode = 'day',year = 2022, month = 12,day = 25)
    def ca():
...
def hotel():
    ...
    def validate_date(date_str):
        ...
        if(validdate_flag == 0):
            ...
            if(yeartemp.isdigit()):
                if(int(yeartemp)<2022):
                    validdate_flag = 1            
                if(int(yeartemp)>2023):
                    extention_flag=1
                    validdate_flag = 1            
            else:
                validdate_flag = 1
    ...
    def availability_window():
        ...
        if(validation_flag == 0):          
            ...
            if (ischeckin_valid_date == 0):
                ...
                avlabel4=Label(avframe,text="Please enter valid date",font=("Californian FB",16))
                avlabel4.pack(pady=8)
                validation_flag = 1
            ...
            if (validation_flag == 0):
                ...
                if(ischeckout_valid_date == 1):
                    avlabel5=Label(avframe,text="Please enter valid date",font=("Californian FB",16))
                    avlabel5.pack(pady=8)
                    validation_flag = 1
